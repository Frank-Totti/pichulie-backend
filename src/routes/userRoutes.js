...
const { login, requestPasswordReset, resetPassword, validateResetToken, resendResetToken, register, update, uploadProfilePicture, getData } = require('../apps/user/controllers/controllers');
